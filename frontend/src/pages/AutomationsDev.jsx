...
## Títulos para análise:`
  ...
  const handleGenerateAgentScript = async () => {
    ...
    try {
      ...
      const endpoint = '/api/premise/generate-agent-script'
      const requestBody = {
...
`
  ...
  const openRouterModels = [
    ...
    { id: 'google/gemini-2.0-flash-lite', name: 'Gemini 2.0 Flash Lite', free: false },
              ...
              <div className="bg-gray-800 rounded-lg p-4 text-left max-w-md mx-auto">
                ...
                <button 
                  onClick={() => {
                    ...
                    window.open(`/api/videos/${createdVideo.video_id}/download`, '_blank')
                  }}
